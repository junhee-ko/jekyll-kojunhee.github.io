...
<!--   <img name="tooltip" src="http://www.cisco.com/swa/i/pixel.gif" border="0" width="400" height="15" />  -->
...
<input name="action" type="hidden" /> <input name="condition" type="hidden" /> <input name="type" type="hidden" /> <input name="company_id" type="hidden" /> <input name="company_country_id" type="hidden" /> <input name="country_cd" type="hidden" /> <!-- top margin spacing row -->
